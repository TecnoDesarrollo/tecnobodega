	...
	class ShowBizOutput{
		...
		public function putSliderBase($sliderID){
			...
			<style type="text/css">
				...
				.showbiz-drag-mouse {
					cursor:url(<?php echo SHOWBIZ_PLUGIN_URL; ?>showbiz-plugin/css/openhand.cur), move;
				}
				.showbiz-drag-mouse.dragged {
					cursor:url(<?php echo SHOWBIZ_PLUGIN_URL; ?>showbiz-plugin/css/closedhand.cur), move;
				}
			</style>
			<?php endif?>
