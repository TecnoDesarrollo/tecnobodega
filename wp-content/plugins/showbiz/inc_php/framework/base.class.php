<?php
	...
	class UniteBaseClassBiz{
		...
		protected static function addScript($scriptName,$folder="js",$handle=null, $waitfor = array()){
			...
			wp_register_script($handle , self::$url_plugin .$folder."/".$scriptName.".js", $waitfor, GlobalsShowBiz::SLIDER_REVISION );
			wp_enqueue_script($handle);
		}
		...
		protected static function addStyle($styleName,$handle=null,$folder="css"){
			...
			wp_register_style($handle , self::$url_plugin .$folder."/".$styleName.".css", array(), GlobalsShowBiz::SLIDER_REVISION );
