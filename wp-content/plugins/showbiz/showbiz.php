...
$showbizVersion = "1.7.2";
$currentFile = __FILE__;
$currentFolder = dirname($currentFile);

define( 'SHOWBIZ_PLUGIN_URL', str_replace('index.php','',plugins_url( 'index.php', __FILE__ )));
...
try{
	...
	function showbiz_shortcode($args){
		...
		if (empty($sliderAlias)){ $sliderAlias = UniteFunctionsBiz::getVal($args,'alias'); }
		ob_start();
