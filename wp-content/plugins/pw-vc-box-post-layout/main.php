<?php
/*
Plugin Name: PW Boxes Post Layout For Visual Composer
Plugin URI: http://proword.net/Vc_Post_Layout/
Description: Display your post item(s) in a beautiful Box style layout.
Version: 1.3
Author: Proword
...
if (!class_exists('VC_PW_POST_LAYOUT_BOXES_CLASS')) {
	class VC_PW_POST_LAYOUT_BOXES_CLASS
	{
		...
		{
			echo PW_PS_PL_NOTIC_BOXES;
		}
		
	}

	new VC_PW_POST_LAYOUT_BOXES_CLASS;
}
